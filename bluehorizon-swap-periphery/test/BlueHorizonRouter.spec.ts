...
import ISwapPair from '@BlueHorizonArt/swap-core/build/IBlueHorizonPair.json'
...
import ERC20 from '../build/IERC20.json'
...
describe('BlueHorizonRouter', () => {
  ...
  it('addLiquidity', async () => {
    ...
    console.log(token0Amount.toString())
  ...
  it('getAmountOut', async () => {
    ...
    await expect(router.getAmountOut(bigNumberify(0), bigNumberify(100), bigNumberify(100))).to.be.revertedWith(
      'BlueHorizonLibrary: INSUFFICIENT_INPUT_AMOUNT'
    )
  ...
  it('getAmountIn', async () => {
    ...
    await expect(router.getAmountIn(bigNumberify(0), bigNumberify(100), bigNumberify(100))).to.be.revertedWith(
      'BlueHorizonLibrary: INSUFFICIENT_OUTPUT_AMOUNT'
    )
  ...
  it('getAmountsOut', async () => {
    ...
    await expect(router.getAmountsOut(bigNumberify(2), [token0.address])).to.be.revertedWith(
      'BlueHorizonLibrary: INVALID_PATH'
    )
  ...
  describe('swapExactTokensForTokens', () => {
    ...
    it('gas', async () => {
      ...
      expect(receipt.gasUsed).to.eq(102538)
    }).retries(3)
  })
  ...
  describe('swapExactETHForTokens', () => {
    ...
    it('gas', async () => {
      ...
      const receipt = await tx.wait()
      expect(receipt.gasUsed).to.eq(139420)
    }).retries(3)
  })
